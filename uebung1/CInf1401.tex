...
\begin{enumerate}[label=\protect\circled{\arabic*},leftmargin=5em]
   ...
   \item Nach jeder Operation wird die Adresse 0100 angesprungen.
\end{enumerate}
...
% \begin{tabularx}{\textwidth}{|L||L|L|L||L|L|X|} 
   ...
   0709 & 7E & 0100 & & JMP & 0100 & Done \\\hline
   ...
   0716 & 7E & 0100 & & JMP & 0100 & Done \\\hline
