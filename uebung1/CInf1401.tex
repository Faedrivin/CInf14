...
\begin{assemblertable}
   0504 &    &      & Z          & .BYTE & 2 & Variable Z                      \\\hline\hline
   ...
   080A & 86 & FF   &          & LDA  & \#0      & Initialise byte for use with X register\\\hline % this seems to be the -1
   080C & B7 & 0702 &          & STA  & ZERO     &                           \\\hline
   080F & 86 & 00   &          & LDA  & \#-1     & Initialise byte for use with X register\\\hline % and this 0
   0811 & B7 & 0703 &          & STA  & MINUS\_1 &                           \\\hline
   0814 & 86 & 01   &          & LDA  & \#1      & Initialise or reload loop counter \\ \hline % why "reload"?
   0816 & B7 & 0705 &          & STA  & COUNTER  &                           \\\hline
   0817 & BE & 0703 &          & LDX  & ZERO     & Zero out X                \\\hline
   0818 & B6 & 0704 & LOOP:    & LDA  & COUNTER  & Start loop                \\\hline
   081B & 8B & 01   &          & ADDA & \#1      & Increment counter         \\\hline % think we should store it as well
   081D & B1 & 0700 &          & CMPA & LOOP\_SIZE & Check if done           \\\hline
   0820 & 27 &      &          & BEQ  & EXIT     & If zero, we're done       \\\hline % misses offset yet
   0822 & B6 & 0504 & CHK\_Z:  & LDA  & Z        & Load Z into A             \\\hline % can A even hold 2 Byte?
   0824 & BE & 0701 &          & LDX  & LIMIT    & Load limit in LIMIT into X. Assume low nibble is set \\\hline % Comment [1] above
   0826 & 81 & 00   & DECR:    & CMPA & \#0      & Check if Z is zero        \\\hline 
   0828 & 27 &      &          & BEQ  & BRANCH2  & If yes, can't be > 50, go to else branch\\\hline % misses offset yet
   082A & 8C & 0702 &          & CMPX & ZERO     & Compare X with 0. Assume low nibble is
                                                   compared, high nibble is 0 anyway\\\hline % not sure if we can make assumptions
   ...
   0834 & BB & 0504 &          & ADDA & Z        & Add 50 to Z               \\\hline % x*3, not 50*3
