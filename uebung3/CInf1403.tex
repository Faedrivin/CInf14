   ...
   \item \hspace{\linewidth} % weirdly, i must put space here in order for the
      ...
      \begin{center}
         \begin{tikzpicture}[node distance=.5cm,every node/.style={scale=.8}] % TODO: Encapsulate some of this stuff in macros
            ...
            \fill[black,name intersections={of=a-line and a-or-1}] (intersection-1) circle (2pt);
            \fill[black,name intersections={of=b-line and b-or-1}] (intersection-1) circle (2pt);
            \fill[black,name intersections={of=c-line and c-or-1}] (intersection-1) circle (2pt);
            \begin{scope} % scope to only clip circles
               \clip (or-1.north west) rectangle ++(-3cm,-3cm); % to cut circles
               \filldraw[fill=white] ($(or-1.215)$) circle (2pt);
            \end{scope}
            ...
            \fill[black,name intersections={of=a-line and a-or-2}] (intersection-1) circle (2pt);
            \fill[black,name intersections={of=b-line and b-or-2}] (intersection-1) circle (2pt);
            \fill[black,name intersections={of=c-line and c-or-2}] (intersection-1) circle (2pt);
            \begin{scope} % scope to only clip circles
               \clip (or-2.north west) rectangle ++(-3cm,-3cm); % to cut circles
               \filldraw[fill=white] ($(or-2.145)$) circle (2pt);
            \end{scope}
            ...
            \fill[black,name intersections={of=a-line and a-or-3}] (intersection-1) circle (2pt);
            \fill[black,name intersections={of=b-line and b-or-3}] (intersection-1) circle (2pt);
            \fill[black,name intersections={of=c-line and c-or-3}] (intersection-1) circle (2pt);
            \begin{scope} % scope to only clip circles
               \clip (or-3.north west) rectangle ++(-3cm,-3cm); % to cut circles
               \filldraw[fill=white] ($(or-3.145)$) circle (2pt);
               \filldraw[fill=white] ($(or-3.215)$) circle (2pt);
            \end{scope}
            ...
            \fill[black,name intersections={of=a-line and a-or-4}] (intersection-1) circle (2pt);
            \fill[black,name intersections={of=b-line and b-or-4}] (intersection-1) circle (2pt);
            \fill[black,name intersections={of=c-line and c-or-4}] (intersection-1) circle (2pt);
            \begin{scope} % scope to only clip circles
               \clip (or-4.north west) rectangle ++(-3cm,-3cm); % to cut circles
               \filldraw[fill=white] ($(or-4.145)$) circle (2pt);
               \filldraw[fill=white] ($(or-4.180)$) circle (2pt);
               \filldraw[fill=white] ($(or-4.215)$) circle (2pt);
            \end{scope}
