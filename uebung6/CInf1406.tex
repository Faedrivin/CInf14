...
\begin{center}
  \noindent\begin{tikzpicture}[xscale=.8,yscale=.7]
    ...
    \def\dn{, \hAone)  -- ++(0, -\diff) -- (}
    \drawundef{\hAone}{5}
    \draw (5, \hAone) -- (7 \dn 13 \up 15 \dn 17, \hAzero);
    ...
    \def\dn{, \hCone)  -- ++(0, -\diff) -- (}
    \drawundef{\hCone}{5}
    \draw (5, \hCone) -- (7 \dn 13 \up 15 \dn 17 \up 17, \hCone);
...
\ex{NRZI-Codierer}{3 + 2 + 4 + 2 + 4 + 4 = 19}
\subex{}
...
\begin{center}
   \noindent\begin{tikzpicture}
      ...
      \foreach \x in {1,...,32}{
         \draw[dotted] (\x*\pulsewidth,0) -- ++(0,4);
      }
...
\ex{Analyse eines Registerbausteins}{1 + 4 + 6 + 6 + 8 + 9 = 34 P}
